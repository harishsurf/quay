...
import { IMembers } from 'src/resources/MembersResource';
  ...
  export default function CollaboratorsViewToolbar (props: CollaboratorsViewToolbarProps) {
  ...
  interface CollaboratorsViewToolbarProps {
    ...
    onItemSelect: (item: IMembers, rowIndex: number, isSelecting: boolean) => void;
    page: number;
